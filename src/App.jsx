...
console.log(songname)
 ...
 await Storage.remove(songname);
  await API.graphql(graphqlOperation(deleteSong, { input: { id:id }}));
  fetchSongs()
  }
  ...
  return (
    ...
    {songPlaying === idx ? <PauseIcon /> : <PlayArrowIcon />}
                    ...
                    <div className="songDescription" onClick={()=>removeSong(song.id, song.filePath)}>remove</div>
                </div>
                {songPlaying === idx ? (
